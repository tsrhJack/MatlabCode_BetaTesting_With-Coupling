...
function [mainFigure, figureName, bincounts] = VectorCode(jointOrSegment1, plane1, norm1, ...
    ...
    if isempty(strmatch(event1,eventsMap))
    ...
    elseif isempty(strmatch(plane2, planesMap))
        ...
        try
            ...
            warning('off','MATLAB:colon:nonIntegerIndex')
                ...
                array2 = array2(CycleNorm(min(strmatch(event1,eventsMap))) + 1:CycleNorm(max(strmatch(event2,eventsMap))) + 1);
            ...
            case 'MATLAB:badsubscript'
                ...
                mainFigure = 9999;
                figureName = 'Error';
                bincounts = [999,999,999,999,999,999];
                return
    ...
    primary_title = char(strcat(jointOrSegment1, {' '}, plane1, ' vs ', jointOrSegment2, {' '}, plane2));
    subplot(2,4,[1,2,3,4])
    plot(t, array1, 'DisplayName', char(strcat(jointOrSegment1, {' '}, plane1))); hold on;
    plot(t, array2, 'DisplayName', char(strcat(jointOrSegment2, {' '}, plane2)));
